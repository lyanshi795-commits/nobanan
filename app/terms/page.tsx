                ...
                <div className="mx-auto max-w-4xl">
                    ...
                    <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground leading-relaxed mb-4">
                                <strong>Refunds:</strong> We will respond to all refund requests within 3 business days. Refund eligibility is determined on a case-by-case basis. To request a refund, please contact our support team at leo@nobanban.online.
                            </p>
                            <p className="text-muted-foreground leading-relaxed">
